...
import 'package:money_manger/models/Transaction_model.dart';
import 'package:money_manger/pages/add_name.dart';
import 'package:money_manger/pages/add_rename.dart';
import 'package:money_manger/pages/add_transaction.dart';
import 'package:money_manger/widgets/confirm_dialog.dart';
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasData) {
              if (snapshot.data!.isEmpty) {
                return Center(
                  child: Text("Vui lòng thêm giao dịch của bạn!"),
                );
              }
                    ...
                    child: Row(
                      ...
                      children: [
                        Row(children: [
                          ...
                          Text(
                            "Chào, ${preferences.getString('name')}",
                            style: TextStyle(
                              fontSize: 22,
    ...
    return InkWell(
      onLongPress: () async {
        bool? answer = await showConfirmDialog(
          context,
          "CẢNH BÁO",
          "Thao tác này sẽ xóa bản ghi chi phí này. Hành động này là không thể đảo ngược. Bạn có muốn tiếp tục?",
        );
